...
## Шесть выбрано не на глаз: при нём тайл 16 px увеличивается ровно в шесть
## раз, а спрайт персонажа — ровно вдвое. Нецелые множители размывают
## пиксель-арт, и вся работа художника пропадает.
@export var zoom_base := 6.0
